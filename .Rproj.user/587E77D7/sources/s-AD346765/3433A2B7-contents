...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    fluidRow(
      # A static value Box
      valueBox("2,195","New Cases", color = "red", width = 3, icon = icon("arrow-alt-circle-up")),
      valueBox("8","New Deaths", color = "olive",width = 3, icon = icon("arrow-alt-circle-up")),
      valueBox("1,427","New Recovered", color = "light-blue",width = 3, icon = icon("arrow-alt-circle-up")),
      valueBox("19,854","Active Cases", color = "navy", width = 3, icon = icon("arrow-alt-circle-up")),
    ),
